...
def jogar():
    ...
    while flag:  # Loop principal do jogo, continua enquanto flag for True
        ...
        while not acertou and not enforcou:  # Loop do jogo, continua enquanto o jogador não acertar ou não foi enforcado
            chute = pede_chute() 
            os.system("cls") 
